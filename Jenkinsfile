...
def gitHubAccessToken = "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"
def TAG = getTag()
def ENV = getENV()
            ...
            steps{
                ...
                script{
                    sh """   
                        ...
                        git remote set-url origin https://shclub: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@github.com/shclub/edu13-gitops
